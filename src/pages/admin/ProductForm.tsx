      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="border-sage-light/50">
          ...
          <CardContent className="space-y-6">
            <div>
              <Label htmlFor="keyBenefits" className="mb-2 block">
                Product Description
              </Label>
              <div style={{ minHeight: "150px" }}>
                <ReactQuill
                  ...
                  onChange={(value) =>
                    setFormData((prev) => ({ ...prev, keyBenefits: value }))
                  }
            ...
            <div>
              <Label htmlFor="skinSuitability" className="mb-2 block">
                Recommended for
              </Label>
              <div style={{ minHeight: "120px" }}>
                <ReactQuill
                  ...
                  onChange={(value) =>
                    setFormData((prev) => ({ ...prev, skinSuitability: value }))
                  }
                  modules={quillModules}
                  formats={quillFormats}
            ...
            <div>
              <Label htmlFor="howToUse" className="mb-2 block">
                How to Use
              </Label>
              <div style={{ minHeight: "150px" }}>
                <ReactQuill
                  ...
                  onChange={(value) =>
                    setFormData((prev) => ({ ...prev, howToUse: value }))
                  }
                  modules={quillModules}
                  formats={quillFormats}
                ...
                <div>
                  ...
                  <div style={{ minHeight: "150px" }}>
                    <ReactQuill
                      ...
                      value={block.content}
                      onChange={(value) =>
                        updateExtraInfoBlock(index, "content", value)
                      }
                      modules={quillModules}
                      formats={quillFormats}
